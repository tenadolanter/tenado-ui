...
export default {
              ...
              {columns.map((column, cellIndex) => (
                ...
                >
                  ...
                  >
                    ...
                    {column.filterable ? (
                      <span
                        class="td-table__column-filter-trigger"
                        on-click={($event) =>
                      ...
                      >
                        <i
                          class={[
                            "td-icon-arrow-down",
                            column.filterOpened ? "td-icon-arrow-up" : "",
                          ]}
                        />
                      </span>
                    ) : (
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector(".td-table__column-filter-trigger") || cell;
