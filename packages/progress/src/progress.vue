<template>
  <div
    ...
    aria-valuemax="100"
  >
    <div class="td-progress-bar" v-if="type === 'line'">
      <div
        class="td-progress-bar__outer"
        :style="{
          height: strokeWidth + 'px',
          backgroundColor: defineBackColor,
        }"
      >
        <div class="td-progress-bar__inner" :style="barStyle">
          <div
            class="td-progress-bar__innerText"
