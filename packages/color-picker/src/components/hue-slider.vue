<template>
  <div class="td-color-hue-slider" :class="{ 'is-vertical': vertical }">
    <div class="td-color-hue-slider__bar" @click="handleClick" ref="bar"></div>
    <div
      class="td-color-hue-slider__thumb"
      :style="{
        left: thumbLeft + 'px',
        top: thumbTop + 'px',
      }"
