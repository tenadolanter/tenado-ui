<template>
  <transition name="td-notification-fade">
    ...
    >
      <i
        class="td-notification__icon"
        :class="[typeClass, iconClass]"
        v-if="type || iconClass"
      >
      </i>
      <div
        class="td-notification__group"
        :class="{ 'is-with-icon': typeClass || iconClass }"
      >
        <h2 class="td-notification__title" v-text="title"></h2>
        <div class="td-notification__content" v-show="message">
          <slot>
