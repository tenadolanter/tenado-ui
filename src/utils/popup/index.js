...
import PopupManager from "@tenado/ui/src/utils/popup/popup-manager";
  ...
  methods: {
    ...
    doOpen(props) {
      ...
      if (modal) {
        ...
        if (props.lockScroll) {
          ...
          addClass(document.body, "td-popup-parent--hidden");
        }
      }
    ...
    restoreBodyStyle() {
      if (this.modal && this.withoutHiddenClass) {
        ...
        removeClass(document.body, "td-popup-parent--hidden");
      }
