...
```html
<td-cascader :options="options"></td-cascader>
...
```html
<td-cascader :options="options" clearable></td-cascader>
...
```html
<td-cascader :options="options" :show-all-levels="false"></td-cascader>
...
<div class="block">
  ...
  <td-cascader :options="options" :props="props" clearable></td-cascader>
</div>
<div class="block">
...
```html
<td-cascader :props="props"></td-cascader>
...
```html
<td-cascader-panel :options="options"></td-cascader-panel>
